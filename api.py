...
from banco import Autor, Postagem, app, db
import jwt # Utilizando pyjwt
from datetime import datetime, timedelta
from functools import wraps

# Decorator que adiciona a verificação de token as funções da API
...
Autores
"""
# Obtendo autores - GET - https://localhost:5000/autores
@app.route('/autores')
@token_obrigatorio
...
# Obtendo autores por id - GET - https://localhost:5000/autores/1
...
# Incluindo autores - POST - https://localhost:5000/autores
...
# Alterando autores por id - PUT - https://localhost:5000/autores/1
...
# Excluindo autores - DELETE - https://localhost:5000/autores/1
...
# Inicializando a aplicação na porta 5000
